...
export const activationTemplate = ({
  ...
  return `
    ...
    <p>Thank you for choosing Fakebook! We hope you're enjoying your experience with our platform.</p>
    <p>This is your activation link for your account: <a href="${activationLink}">Activation Link</a></p>
    <p>Please keep in mind that Fakebook is currently in its beta testing phase. We apologize for any inconvenience you may encounter during this time. We are committed to continuously improving your experience and making Fakebook the best it can be.</p>
    ...
    <ul>
      ...
      <li><b>Feedback is appreciated: </b>Please share your feedback with us so we can continue to improve Fakebook.</li>
    </ul>
    <p>We appreciate your patience and understanding as we work to make Fakebook the best social media platform for you.</p>
    <p>Thank you for being a part of the Fakebook community!</p>
    <br>
    <p>Sincerely, </p>
    <p>The Fakebook Team</p>
    <hr>
    <small style="color: #666">2024 Fakebook</small>
  </div>`
}
